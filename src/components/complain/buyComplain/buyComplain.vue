...
export default {
  ...
  data () {
    return {
      ...
      apiUrl: '/api/platform/complain/getComplainListByStatusBuyerPhone'
    }
  },
  computed: {
    params () {
  ...
  methods: {
    ...
    lookDetail (row) {
      this.$router.push({ name: 'sellerComplainDetail', query: { messageComplainId: row.messageComplainId, id: 1 } })
    },
    setList (data) {
